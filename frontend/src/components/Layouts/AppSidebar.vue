...
const customerLinks = [
  { label: 'Cần hỗ trợ', icon: LucideAlertCircle, to: 'Support Inbox' },
  { label: 'Tiềm năng', icon: LeadsIcon, to: 'Prospects' },
  { label: 'Lịch hẹn', icon: LucideCalendar, to: 'Appointments' },
  { label: 'Tất cả khách', icon: LucideUsers, to: 'All Customers' },
]

const aiLinksAdmin = [
  { label: 'Chiến dịch', icon: LucideRadio, to: 'Voice Campaigns' },
  { label: 'Cuộc gọi đến', icon: LucidePhoneIncoming, to: 'Voice Inbound' },
  { label: 'SMS & Zalo', icon: LucideMessageSquare, to: 'Voice CSKH' },
  { label: 'Lịch sử Gọi', icon: PhoneIcon, to: 'Voice Call History' },
  { label: 'Cài đặt AI', icon: LucideCpu, to: 'AI Settings' },
]
...
const allViews = computed(() => {
  const aiLinks = isManager() ? aiLinksAdmin : aiLinksStaff
