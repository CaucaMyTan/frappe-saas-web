...
const routes = [
  ...
  },
  {
    path: '/voice/config',
    name: 'Voice Config',
    component: () => import('@/pages/voice/VoiceClientConfig.vue'),
  },
  {
    path: '/voice/campaigns',
    name: 'Voice Campaigns',
    component: () => import('@/pages/voice/VoiceCampaigns.vue'),
  },
  {
    path: '/voice/appointments',
    name: 'Voice Appointments',
    component: () => import('@/pages/voice/VoiceAppointments.vue'),
  },
  {
    path: '/voice/cskh',
    name: 'Voice CSKH',
    component: () => import('@/pages/voice/VoiceCskh.vue'),
  },
  {
    path: '/voice/fb-campaigns',
    name: 'Voice FB Campaigns',
    component: () => import('@/pages/voice/VoiceFbCampaigns.vue'),
  },
  {
    path: '/voice/agents',
    name: 'Voice Agents',
    component: () => import('@/pages/voice/VoiceAgents.vue'),
  },
  {
    path: '/voice/inbound',
    name: 'Voice Inbound',
    component: () => import('@/pages/voice/VoiceInbound.vue'),
  },
  {
    path: '/voice/call-history',
    name: 'Voice Call History',
    component: () => import('@/pages/voice/VoiceCallHistory.vue'),
  },
  {
    path: '/voice/sms-zalo',
    name: 'Voice SMS Zalo',
    component: () => import('@/pages/voice/VoiceSmsZalo.vue'),
  },
  {
    path: '/support-inbox',
    name: 'Support Inbox',
    component: () => import('@/pages/SupportInbox.vue'),
  },
  {
    path: '/prospects',
    name: 'Prospects',
...
router.beforeEach(async (to, from, next) => {
  ...
  if (isLoggedIn && to.name !== 'Not Permitted' && !isCrmUser()) {
    ...
    if (!viewType) {
      ...
      if (!hasUserDefault && to.name === 'All Customers') {
